...
public class AmqpsProvisioningSaslHandlerTest
{
    ...
    // Tests_SRS_AMQPSPROVISIONINGSASLHANDLER_34_004: [If the provided mechanisms array does not contain "TPM" then this function shall throw a SecurityException.]
    @Test (expected = SecurityException.class)
    public void choseSaslMechanismThrowsIfTPMNotPresent()
    {
        //arrange
    ...
    @Test
    public void choseSaslMechanismReturnsTPMIfPresent()
    {
        //arrange
        AmqpsProvisioningSaslHandler handler = Deencapsulation.newInstance(AmqpsProvisioningSaslHandler.class, idScope, registrationId, endorsementKey, storageRootKey, mockedResponseCallback, new Object());
    ...
    public void choseSaslMechanismThrowsIfNotWaitingToChooseMechanism()
    {
        //arrange
        AmqpsProvisioningSaslHandler handler = Deencapsulation.newInstance(AmqpsProvisioningSaslHandler.class, idScope, registrationId, endorsementKey, storageRootKey, mockedResponseCallback, new Object());
    ...
    public void buildInitSuccess()
    {
        ...
        //act
        byte[] actualInitPayload = handler.buildInitPayload("TPM");
    ...
    @Test
    public void handleChallengeFirstChallengeSuccess()
    {
        //arrange
        AmqpsProvisioningSaslHandler handler = Deencapsulation.newInstance(AmqpsProvisioningSaslHandler.class, idScope, registrationId, endorsementKey, storageRootKey, mockedResponseCallback, new Object());
        handler.chooseSaslMechanism(new String[]{"TPM", "notTPM"});
    ...
    @Test
    public void handleChallengeSecondChallengeSuccess()
    {
        //arrange
        AmqpsProvisioningSaslHandler handler = Deencapsulation.newInstance(AmqpsProvisioningSaslHandler.class, idScope, registrationId, endorsementKey, storageRootKey, mockedResponseCallback, new Object());
        handler.chooseSaslMechanism(new String[]{"TPM", "notTPM"});
    ...
    @Test (expected = IllegalArgumentException.class)
    public void handleChallengeThrowsForNullChallengeData()
    {
        //arrange
        AmqpsProvisioningSaslHandler handler = Deencapsulation.newInstance(AmqpsProvisioningSaslHandler.class, idScope, registrationId, endorsementKey, storageRootKey, mockedResponseCallback, new Object());
        handler.chooseSaslMechanism(new String[]{"TPM", "notTPM"});
    ...
    @Test (expected = IllegalStateException.class)
    public void handleFirstChallengeThrowsForChallengeDataWithIncorrectControlByte()
    {
        //arrange
        AmqpsProvisioningSaslHandler handler = Deencapsulation.newInstance(AmqpsProvisioningSaslHandler.class, idScope, registrationId, endorsementKey, storageRootKey, mockedResponseCallback, new Object());
        handler.chooseSaslMechanism(new String[]{"TPM", "notTPM"});
    ...
    @Test (expected = IllegalStateException.class)
    public void handleSecondChallengeThrowsForChallengeDataWithIncorrectControlByte()
    {
        //arrange
        AmqpsProvisioningSaslHandler handler = Deencapsulation.newInstance(AmqpsProvisioningSaslHandler.class, idScope, registrationId, endorsementKey, storageRootKey, mockedResponseCallback, new Object());
        handler.chooseSaslMechanism(new String[]{"TPM", "notTPM"});
    ...
    @Test (expected = IllegalStateException.class)
    public void handleThirdChallengeThrowsForChallengeDataWithIncorrectControlByte()
    {
        //arrange
        AmqpsProvisioningSaslHandler handler = Deencapsulation.newInstance(AmqpsProvisioningSaslHandler.class, idScope, registrationId, endorsementKey, storageRootKey, mockedResponseCallback, new Object());
        handler.chooseSaslMechanism(new String[]{"TPM", "notTPM"});
    ...
    @Test (expected = IllegalStateException.class)
    public void handleChallengeThrowsIfWaitingToChooseMechanism()
    {
        //arrange
        AmqpsProvisioningSaslHandler handler = Deencapsulation.newInstance(AmqpsProvisioningSaslHandler.class, idScope, registrationId, endorsementKey, storageRootKey, mockedResponseCallback, new Object());
    ...
    // Tests_SRS_AMQPSPROVISIONINGSASLHANDLER_34_020: [If this object is not waiting for a first, second or third challenge, this function shall throw an IllegalStateException.]
    @Test (expected = IllegalStateException.class)
    public void handleChallengeThrowsIfWaitingToBuildInitPayload()
    {
        //arrange
        AmqpsProvisioningSaslHandler handler = Deencapsulation.newInstance(AmqpsProvisioningSaslHandler.class, idScope, registrationId, endorsementKey, storageRootKey, mockedResponseCallback, new Object());
        handler.chooseSaslMechanism(new String[]{"TPM", "notTPM"});
    ...
    // Tests_SRS_AMQPSPROVISIONINGSASLHANDLER_34_020: [If this object is not waiting for a first, second or third challenge, this function shall throw an IllegalStateException.]
    @Test (expected = IllegalStateException.class)
    public void handleChallengeThrowsIfWaitingForSaslOutcome()
    {
        //arrange
        AmqpsProvisioningSaslHandler handler = Deencapsulation.newInstance(AmqpsProvisioningSaslHandler.class, idScope, registrationId, endorsementKey, storageRootKey, mockedResponseCallback, new Object());
        handler.chooseSaslMechanism(new String[]{"TPM", "notTPM"});
    ...
    // Tests_SRS_AMQPSPROVISIONINGSASLHANDLER_34_022: [If the sasl outcome is not OK, this function shall throw a SecurityException.]
    @Test (expected = SecurityException.class)
    public void handleOutcomeAuthThrowsSecurityException()
    {
        //arrange
        AmqpsProvisioningSaslHandler handler = Deencapsulation.newInstance(AmqpsProvisioningSaslHandler.class, idScope, registrationId, endorsementKey, storageRootKey, mockedResponseCallback, new Object());
        handler.chooseSaslMechanism(new String[]{"TPM", "notTPM"});
    ...
    // Tests_SRS_AMQPSPROVISIONINGSASLHANDLER_34_022: [If the sasl outcome is not OK, this function shall throw a SecurityException.]
    @Test (expected = SecurityException.class)
    public void handleOutcomeSysTempThrowsSecurityException()
    {
        //arrange
        AmqpsProvisioningSaslHandler handler = Deencapsulation.newInstance(AmqpsProvisioningSaslHandler.class, idScope, registrationId, endorsementKey, storageRootKey, mockedResponseCallback, new Object());
        handler.chooseSaslMechanism(new String[]{"TPM", "notTPM"});
    ...
    // Tests_SRS_AMQPSPROVISIONINGSASLHANDLER_34_022: [If the sasl outcome is not OK, this function shall throw a SecurityException.]
    @Test (expected = SecurityException.class)
    public void handleOutcomeSysThrowsSecurityException()
    {
        //arrange
        AmqpsProvisioningSaslHandler handler = Deencapsulation.newInstance(AmqpsProvisioningSaslHandler.class, idScope, registrationId, endorsementKey, storageRootKey, mockedResponseCallback, new Object());
        handler.chooseSaslMechanism(new String[]{"TPM", "notTPM"});
    ...
    // Tests_SRS_AMQPSPROVISIONINGSASLHANDLER_34_022: [If the sasl outcome is not OK, this function shall throw a SecurityException.]
    @Test (expected = SecurityException.class)
    public void handleOutcomeSysPermThrowsSecurityException()
    {
        //arrange
        AmqpsProvisioningSaslHandler handler = Deencapsulation.newInstance(AmqpsProvisioningSaslHandler.class, idScope, registrationId, endorsementKey, storageRootKey, mockedResponseCallback, new Object());
        handler.chooseSaslMechanism(new String[]{"TPM", "notTPM"});
    ...
    @Test (expected = IllegalStateException.class)
    public void handleOutcomeThrowsIfNotWaitingOnOutcome()
    {
        //arrange
        AmqpsProvisioningSaslHandler handler = Deencapsulation.newInstance(AmqpsProvisioningSaslHandler.class, idScope, registrationId, endorsementKey, storageRootKey, mockedResponseCallback, new Object());
    ...
    // Tests_SRS_AMQPSPROVISIONINGSASLHANDLER_34_019: [If this object is waiting for the third challenge, and if the sas token is not provided within 3 minutes of waiting, this function shall throw a SecurityException.]
